...
<html lang="en">
                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="{{ route('contactus') }}" class="nav-item nav-link active">Contact</a>
                        </div>
    ...
    <ol class="breadcrumb justify-content-center mb-0">
                ...
                <li class="breadcrumb-item"><a href="{{ route('matangazo2') }}">matangazo</a></li>
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="text-center mx-auto" style="max-width: 700px;">
                                <h1 class="text-primary">MAHALI TULIPO</h1>
                                <p class="mb-4">karibu kata ya mikangaula wilaya ya nanyumbu uonane nasi kwa maelezo zaodi ili tuweze kuyajenga kwa kina zaidi. nyote mnakaribishwa katika kujenga taifa letu la Tanzania<br> <a href="https://htmlcodex.com/contact-form">Download Now</a>.</p>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="h-100 rounded">
                                <iframe class="rounded w-100" 
                                style="height: 400px;" src="{{ asset('img/mk1.png')}}" 
                                loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </div>
                        </div>
                        @if(session('comment'))
<div class="alert alert-success alert-dismissible fade show" role="alert">
    <strong>Shukrani!</strong> {{ session('comment') }}
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>
@endif

                        <div class="col-lg-7">
                            <form action="{{ route('comments') }}" class="" method="post" >
                                @csrf
                                <input type="text" name="name" class="w-100 form-control border-0 py-3 mb-4" placeholder="Jina lako">
                                <input type="number" name="phone" class="w-100 form-control border-0 py-3 mb-4" placeholder="Namba ya simu:">
                                <textarea  name="massege" class="w-100 form-control border-0 mb-4" rows="5" cols="10" placeholder="Wazo lako"></textarea>
                                <button class="w-100 btn form-control border-secondary py-3 bg-white text-primary " type="wasilisha">Submit</button>
                            </form>
                        </div>
                        <div class="col-lg-5">
                            <div class="d-flex p-4 rounded mb-4 bg-white">
                                ...
                                <div>
                                    <h4>Address</h4>
                                    <p class="mb-2">123 mikangaula Nanyumbu</p>
                                </div>
                            </div>
                            <div class="d-flex p-4 rounded mb-4 bg-white">
                                ...
                                <div>
                                    <h4>Mail Us</h4>
                                    <p class="mb-2">mkorihafidhi67@gmail.com</p>
                                </div>
                            </div>
