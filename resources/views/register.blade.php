...
@endif
                    ...
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control" id="floatingInput" placeholder="phone no"name="phone">
                        ...
                        <p class="text-center mb-0">Je unayo akaunti? <a href="{{ route('userlogin') }}">Sign In</a></p>
                        </form>
                    </div>
                </div>
            </div>
