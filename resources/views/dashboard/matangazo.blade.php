...
<body>
    <div class="container-fluid position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('dashboardpage2') }}" class="nav-item nav-link active"><i class="fa fa-keyboard me-2"></i>Posti matangazo</a>
                    <a href="{{ route('dashboardpage1') }}" class="nav-item nav-link"><i class="fa fa-table me-2"></i> bidhaa-maalum</a>
        ...
        <div class="content">
            ...
            <form action="{{ route('uploadedmatangazo') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="container-fluid py-4">
        <div class="row justify-content-center">
            <div class="col-sm-12 col-md-8 col-lg-6">
                <div class="bg-light rounded p-4 shadow-sm">
                    <h6 class="text-primary mb-4 text-center">Toa Tangazo</h6>
                    
                    <!-- Advertisement Title -->
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInput" name="head" 
                               placeholder="Kichwa cha tangazo" required>
                        <label for="floatingInput">Kichwa cha tangazo</label>
                    </div>
                    
                    <!-- Optional Image Upload -->
                    <div class="mb-3">
                        <label for="formFile" class="form-label">Weka picha (hiari)</label>
                        <input class="form-control" type="file" id="formFile" name="imgpath" accept="image/*">
                    </div>
                    
                    <!-- Advertisement Description -->
                    <div class="form-floating mb-3">
                        <textarea class="form-control" placeholder="Maelezo ya tangazo" name="description"
                                  id="floatingTextarea" style="height: 150px;" required></textarea>
                        <label for="floatingTextarea">Maelezo ya tangazo</label>
                    </div>
                    
                    <!-- Submit Button -->
                    <div class="d-grid">
                        <button type="submit" class="btn btn-primary btn-lg">Post Tangazo</button>
                    </div>
                </div>
            </div>
        </div>
