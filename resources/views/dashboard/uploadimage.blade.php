...
<body>
    <div class="container-fluid position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('uploadimage') }}" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Posti bidhaa</a>
        ...
        <div class="content">
            ...
            <form action="{{ route('uploadedmage') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="container-fluid py-4">
        <div class="row justify-content-center">
            <div class="col-sm-12 col-md-8 col-lg-6">
                <div class="bg-light rounded p-4 shadow-sm">
                    <h6 class="text-primary mb-4 text-center">Post Bidhaa Yako</h6>
                    
                    <!-- Product Name -->
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInput" name="pname" 
                               placeholder="Jina la bidhaa" required>
                        <label for="floatingInput">Jina la bidhaa</label>
                    </div>
                    
                    <!-- Product Cost -->
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control" id="floatingCost" name="cost" 
                               placeholder="Gharama (Tsh)" required>
                        <label for="floatingCost">Gharama (Tsh)</label>
                    </div>
                    
                    <!-- Image Upload -->
                    <div class="mb-3">
                        <label for="formFile" class="form-label">Weka Picha</label>
                        <input class="form-control" type="file" id="formFile" name="imgpath" accept="image/*" required>
                    </div>
